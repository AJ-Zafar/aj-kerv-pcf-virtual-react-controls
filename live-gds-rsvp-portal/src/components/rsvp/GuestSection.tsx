  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <p className="govuk-body">
        You can bring up to {maxGuests} guest{maxGuests !== 1 ? 's' : ''} to this event.
      </p>
      ...
      {formData.guests.map((guest, i) => (
        <div key={guest.attendeeId} className="govuk-summary-card govuk-!-margin-bottom-6">
      ...
      {formData.guests.length < maxGuests && (
        <GovButton type="button" variant="secondary" onClick={addGuest}>
          Add a guest
        </GovButton>
      )}
